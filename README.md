...
官方Dense-S/B均已完成211视频/792窗口：S为68.9767%、2347.894 GFLOPs/窗口；B为71.1417%、8082.155 GFLOPs/窗口。两模型的技术验收和开发校准均已通过；S时间分配的792窗口数据已齐，正在采集population，B时间分配继续。分配的全数据AP/CI尚待分析，完整结果和视觉QA通过后才发布正式图。
