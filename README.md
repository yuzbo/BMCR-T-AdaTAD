...
2026-09-12 01:17结果快照：S/B各完整60轮训练均已完成（[完整训练记录](fidelity_20260911/TRAINING_COMPLETION.md)）。已完成2/16个候选的完整测试：第25轮EMA平均mAP为S53.6248%、B58.8581%，均覆盖211视频/792窗口。见[中间测试总表及完整预测](fidelity_20260911/INTERMEDIATE_RESULTS.md)。第30至60轮测试及最终峰值、计算量与时延比较仍待完成。
