...
官方Dense-S/B均已完成211视频/792窗口：S为68.9767%、2347.894 GFLOPs/窗口；B为71.1417%、8082.155 GFLOPs/窗口。两模型的时间分配792窗口数据均已齐，两卡继续采集population；空闲CPU提前计算已齐T切片的官方AP及10000次视频bootstrap，复用原分析缓存。完整结果和视觉QA通过后才发布对应范围的正式图。
