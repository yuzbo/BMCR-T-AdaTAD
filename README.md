...
2026-09-12 00:36更新：S/B各完整60轮训练均已完成，合计12000次正式更新的日志复核通过，16个中间候选检查点及两份终点拷贝均已保留。见[完整训练记录](fidelity_20260911/TRAINING_COMPLETION.md)。首个S第25轮完整测试已开始，后续仍须完成全部中间测试、峰值选模及计算量/时延比较；此次观测时尚无本轮mAP。
