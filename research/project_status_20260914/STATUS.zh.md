...
**最新运行补充（21:21）**：见[ANet恢复与课程轮转](../paper/graph/monitor_20260914_2114/UPDATE.zh.md)。ANet已从结束的1289574.0恢复到1289576.0，起点14360/14752，剩余392；V2/Uniform保存时间切片断点后等待续跑，PBD-S继续。当前1训练运行、3训练Slurm排队、80训练持久等待；完整测试没有新增。机器索引已更新，下方20:39整体报告作为带日期的详细归档保留。
