...
- **8/8实现正确，未支持扩样条件。** 按物理(insert,remove)排序后交替划分，未用gain选干预；fit8归一化，PlainM 2000steps×seeds42/43/44，共25个有效fit state。held regret .00149207135，对比STOP .00141353726；rho .04444444。held chosen gain的三seed方向不一致，均值为负。报告没有独立held随机控制或其video CI，不能伪称已测。拒绝再跑一遍同样8/8作为下一步。
