**2026-09-14 02:56最新恢复状态。** 8个seed42入口作业因首次更新前元数据重复失败，a8930de修复后重提1288730–1288737，控制器1999751。MQ权重已核验，新增课程1288719；当前论文共9个已提交作业，尚未声明两步GPU检查通过。ANet旧1288466因val.09损坏失败，诊断1288738完成，修复并接续1288754排队；准备覆盖已重建为9062/3639，未READY。详细证据见[恢复记录](recovery_20260914_0240/UPDATE.zh.md)。下方旧PID/job ID仅供历史追溯。
