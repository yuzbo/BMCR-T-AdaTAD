...
**当前为五页修订版。** 第1-2页突出最佳已审计算力配对结果与最新K384性能对比，第3-5页保留以下原始分布和曲线。完整重绘运行 `python tools/paper_efficiency_highlight.py`，设计与口径见[DESIGN_REVISION.zh.md](DESIGN_REVISION.zh.md)。下方原三页脚本仅用于重绘补充图。
