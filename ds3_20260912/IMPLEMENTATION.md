...
Remote Linux CPU validation:7 focused tests pass, including actual upstream tiny-ViT clip equivalence, measured sparse FFN execution, physical-coordinate interpolation, legal boundary weighting, frozen-detector input gradients and nonzero LR at60/zero at80. Real GPU preflight and full tests remain separate required stages; CPU validation is not a performance result.
