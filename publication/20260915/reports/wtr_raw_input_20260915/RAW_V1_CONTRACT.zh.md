...
- [预览、有限proposal、tubelet兼容性与三坐标评述](inputs/03_Preview_Proposal_Tubelet_Review.txt)：原附件 `d441b3b0-46c3-4d4c-a623-1c4f75c3c83e/pasted-text.txt`。
- [Episode冻结、Raw-Uniform与四格归因评述](inputs/04_Episode_Factorial_Coordinates_Review.txt)：原附件 `a6a5d549-4f25-4dbe-b2c5-2e4aa6ac4af3/pasted-text.txt`。

此前[Raw输入报告](RAW_INPUT.zh.md)及最初两份输入仍保留。本文件补充其接口，不将附件中“开始实现”的建议解释为本轮执行授权。
